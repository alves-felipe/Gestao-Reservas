...
class UsersEditPage extends StatefulWidget {
  ...
  @override
  UsersEditPageState createState() => UsersEditPageState();
}

class UsersEditPageState extends State<UsersEditPage> {
  ...
  void getUser() async {
    ...
    resp = await http.get(
      Uri.parse('http://192.168.116.75:3030/users/${globals.userEdit}'),
      headers: {
